...
def draw_beer_pong_game(becher_status):
    ...
    positions = {
        'becher1': (-1.5, 2.5),  # Linker oberer Becher
        'becher2': (0, 4),       # Mittlerer oberer Becher
        'becher3': (1.5, 2.5),   # Rechter oberer Becher
        'becher4': (-1.5, -2.5), # Linker unterer Becher
        'becher5': (0, -4),      # Mittlerer unterer Becher
        'becher6': (1.5, -2.5),  # Rechter unterer Becher
    }
